...
/**
 * Dataclass that represents the candidate of the dataset
 * implements IAttirbuteDatum
 */
public class Candidate implements IAttributeDatum {
   ...
   * @param leadershipExperience -- leadershipExperience boolean
   * @param lastPositionDuration --  lastPositionDuration string
   * @param numWorkExperiences -- numWorkExperiences string
   * @param programmingLanguages -- programmingLanguages string
   * @param gpa -- gpa string
   * @param location -- location string
   * @param hired --  hired string
   */
  public Candidate(String gender, boolean leadershipExperience,
                   String lastPositionDuration, String numWorkExperiences,
                   String programmingLanguages, String gpa,
                   String location, boolean hired) {
  ...
  /**
   * Method that checks if two candidates are identical
   * @param o
   * @return
   */
  @Override
